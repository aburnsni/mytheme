...
<?php if(user_access('edit any department_description content') || user_access('edit own department_description content')): ?>
     <ul class="tabs--primary nav nav-tabs">
        <li class="active"><a href="<?php print $base_url; ?>/taxonomy/term/<?php print $field_department['und'][0]['tid']; ?>" role="button">View Class<span class="element-invisible">(active tab)</span></a></li>
